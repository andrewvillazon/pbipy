...
@responses.activate
def test_post_dataset_user(powerbi):
    json_params = {
    ...
    powerbi.datasets.post_dataset_user("cfafbeb1-8037-4d0c-896e-a46fb27ff229", dataset_user_access.identifier, dataset_user_access.principal_type, dataset_user_access.dataset_user_access_right)
...
def test_post_dataset_user_raises_http_error(powerbi):
    ...
    with pytest.raises(HTTPError):
            powerbi.datasets.post_dataset_user("cfafbeb1-8037-4d0c-896e-a46fb27ff229", identifier="john@contoso.com", principal_type="User", dataset_user_access_right="Read")


@responses.activate
def test_post_dataset_user_in_group(powerbi):
    json_params = {
    ...
    powerbi.datasets.post_dataset_user_in_group("f089354e-8366-4e18-aea3-4cb4a3a50b48","cfafbeb1-8037-4d0c-896e-a46fb27ff229", identifier="154aef10-47b8-48c4-ab97-f0bf9d5f8fcf", principal_type="Group", dataset_user_access_right="ReadReshare",)
...
@responses.activate
def test_update_dataset_in_group(powerbi):
    responses.patch(
        "https://api.powerbi.com/v1.0/myorg/groups/f089354e-8366-4e18-aea3-4cb4a3a50b48/datasets/cfafbeb1-8037-4d0c-896e-a46fb27ff229",
        match=[matchers.json_params_matcher({"targetStorageMode": "PremiumFiles"})]        
    )

    powerbi.datasets.update_dataset_in_group("f089354e-8366-4e18-aea3-4cb4a3a50b48","cfafbeb1-8037-4d0c-896e-a46fb27ff229", target_storage_mode="PremiumFiles")


def test_update_dataset_in_group_raises_value_error_no_properties(powerbi):
    with pytest.raises(ValueError):
        powerbi.datasets.update_dataset_in_group("f089354e-8366-4e18-aea3-4cb4a3a50b48","cfafbeb1-8037-4d0c-896e-a46fb27ff229")


def test_update_dataset_in_group_raises_value_error_unsupported_properties(powerbi):
    with pytest.raises(ValueError):
        powerbi.datasets.update_dataset_in_group("f089354e-8366-4e18-aea3-4cb4a3a50b48","cfafbeb1-8037-4d0c-896e-a46fb27ff229", target_storage_mode="PremiumFiles", created_date=None)


@responses.activate
def test_update_dataset_in_group_raises_http_error(powerbi):
    responses.patch(
        "https://api.powerbi.com/v1.0/myorg/groups/f089354e-8366-4e18-aea3-4cb4a3a50b48/datasets/cfafbeb1-8037-4d0c-896e-a46fb27ff229",
        match=[matchers.json_params_matcher({"targetStorageMode": "PremiumFiles"})],
        status=500        
...
@responses.activate
def test_update_datasources(powerbi):
    json_params = {
        "updateDetails": [
            {
            "datasourceSelector": {
    ...
    responses.post("https://api.powerbi.com/v1.0/myorg/datasets/cfafbeb1-8037-4d0c-896e-a46fb27ff229/Default.UpdateDatasources",
        match=[matchers.json_params_matcher(json_params)]
                   )
...
@responses.activate
def test_update_datasources_raises_http_error(powerbi):
    responses.post(
...
@responses.activate
def test_update_direct_query_refresh_schedule_in_group_with_single_option(powerbi):
    json_params = {
        "value": {
            "enabled": False
            }
...
@responses.activate
def test_update_direct_query_refresh_schedule_in_group_with_multiple_options(powerbi):
    json_params = {
        "value": {
            "days": [
                "Sunday",
    ...
    powerbi.datasets.update_direct_query_refresh_schedule_in_group(
        "f089354e-8366-4e18-aea3-4cb4a3a50b48",
        "cfafbeb1-8037-4d0c-896e-a46fb27ff229",
        days=[
            "Sunday",
...
def test_update_direct_query_refresh_schedule_in_group_raises_value_error(powerbi):
    with pytest.raises(ValueError):
        powerbi.datasets.update_direct_query_refresh_schedule_in_group("f089354e-8366-4e18-aea3-4cb4a3a50b48","cfafbeb1-8037-4d0c-896e-a46fb27ff229", disable=True)


@responses.activate 
def test_update_direct_query_refresh_schedule_in_group_raises_http_error(powerbi):
    responses.patch(
        "https://api.powerbi.com/v1.0/myorg/groups/f089354e-8366-4e18-aea3-4cb4a3a50b48/datasets/cfafbeb1-8037-4d0c-896e-a46fb27ff229/directQueryRefreshSchedule",
        status=404
    )
...
@responses.activate
def test_execute_queries_in_group_request(powerbi, execute_query):
    json_params = {
        "queries": [
            {
            "query": "EVALUATE VALUES(MyTable)"
    ...
    responses.post(
        "https://api.powerbi.com/v1.0/myorg/groups/f089354e-8366-4e18-aea3-4cb4a3a50b48/datasets/cfafbeb1-8037-4d0c-896e-a46fb27ff229/executeQueries",
        match=[matchers.json_params_matcher(json_params)],
        body=execute_query
    )

    powerbi.datasets.execute_queries_in_group(
        "f089354e-8366-4e18-aea3-4cb4a3a50b48",
        "cfafbeb1-8037-4d0c-896e-a46fb27ff229",
        queries="EVALUATE VALUES(MyTable)",
        serializer_settings={"includeNulls": True },
...
@responses.activate
def test_execute_queries_in_group_request_multiple_queries(powerbi):
    json_params = {
        "queries": [
            {"query": "EVALUATE VALUES(MyTable)"},
            {"query": "EVALUATE VALUES(TheirTable)"}
...
@responses.activate
def test_execute_queries_in_group_response(powerbi, execute_query):
    json_params = {
        "queries": [
            {
            "query": "EVALUATE VALUES(MyTable)"
    ...
    results = powerbi.datasets.execute_queries_in_group(
        "f089354e-8366-4e18-aea3-4cb4a3a50b48",
        "cfafbeb1-8037-4d0c-896e-a46fb27ff229",
        queries="EVALUATE VALUES(MyTable)",
        serializer_settings={"includeNulls": True },
...
@responses.activate
def test_execute_queries__in_group_raises_value_error(powerbi):
    with pytest.raises(ValueError):
        powerbi.datasets.execute_queries_in_group("f089354e-8366-4e18-aea3-4cb4a3a50b48","cfafbeb1-8037-4d0c-896e-a46fb27ff229", "EVALUATE VALUES(MyTable)", delay=500)


@responses.activate
def test_execute_queries_in_group_raises_http_error(powerbi):
    responses.post(
        "https://api.powerbi.com/v1.0/myorg/groups/f089354e-8366-4e18-aea3-4cb4a3a50b48/datasets/cfafbeb1-8037-4d0c-896e-a46fb27ff229/executeQueries",
        body="{}",
        status=400
...
@responses.activate
def test_update_refresh_schedule_with_single_option(powerbi):
    json_params = {
        "value": {
            "enabled": False
            }
    ...
    powerbi.datasets.update_refresh_schedule("cfafbeb1-8037-4d0c-896e-a46fb27ff229", enabled=False)


@responses.activate
def test_update_refresh_schedule_with_multiple_options(powerbi):
    json_params = {
        "value": {
            "days": [
                "Sunday",
    ...
    powerbi.datasets.update_refresh_schedule(
        "cfafbeb1-8037-4d0c-896e-a46fb27ff229",
        days=[
            "Sunday",
            "Tuesday",
...
@responses.activate
def test_update_refresh_schedule_in_group_with_single_option(powerbi):
    json_params = {
        "value": {
            "enabled": False
            }
    ...
    responses.patch(
        "https://api.powerbi.com/v1.0/myorg/groups/f089354e-8366-4e18-aea3-4cb4a3a50b48/datasets/cfafbeb1-8037-4d0c-896e-a46fb27ff229/refreshSchedule",
        match=[matchers.json_params_matcher(json_params)]
    )

    powerbi.datasets.update_refresh_schedule_in_group("f089354e-8366-4e18-aea3-4cb4a3a50b48","cfafbeb1-8037-4d0c-896e-a46fb27ff229", enabled=False)


@responses.activate
def test_update_refresh_schedule_in_group_with_multiple_options(powerbi):
    json_params = {
        "value": {
            "days": [
                "Sunday",
    ...
    powerbi.datasets.update_refresh_schedule_in_group(
        "f089354e-8366-4e18-aea3-4cb4a3a50b48",
        "cfafbeb1-8037-4d0c-896e-a46fb27ff229",
        days=[
            "Sunday",
...
def test_update_refresh_schedule_in_group_raises_value_error(powerbi):
    with pytest.raises(ValueError):
        powerbi.datasets.update_refresh_schedule_in_group("f089354e-8366-4e18-aea3-4cb4a3a50b48","cfafbeb1-8037-4d0c-896e-a46fb27ff229", disable=True)


@responses.activate 
def test_update_refresh_schedule_in_group_raises_http_error(powerbi):
    responses.patch(
        "https://api.powerbi.com/v1.0/myorg/groups/f089354e-8366-4e18-aea3-4cb4a3a50b48/datasets/cfafbeb1-8037-4d0c-896e-a46fb27ff229/refreshSchedule",
        status=404
    )
